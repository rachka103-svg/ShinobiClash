      ...
      <div className="flex items-center justify-between gap-3 mb-4 flex-wrap">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button data-testid="chapter-picker" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border transition-colors" style={{ background: "rgba(18,18,26,0.85)", borderColor: "rgba(255,255,255,0.1)", backdropFilter: "blur(4px)" }}>
        ...
        {DIFFICULTIES.map((d) => {
          ...
          return (
            <button
              ...
              }`} style={!active ? { background: "rgba(18,18,26,0.7)", backdropFilter: "blur(4px)" } : undefined}
            >
              {d.label}
        ...
        {chapterStages.map((stage, i) => {
          ...
          return (
            <motion.button
              ...
              style={{
                background: locked
                  ? "linear-gradient(135deg, rgba(20,20,28,0.6), rgba(12,12,18,0.7))"
                  : isBoss
                  ? "linear-gradient(120deg, rgba(255,87,34,0.18), rgba(15,12,10,0.92))"
                  : state === "completed"
                  ? "linear-gradient(135deg, rgba(12,30,20,0.85), rgba(10,14,12,0.9))"
                  : "linear-gradient(135deg, rgba(22,22,30,0.88), rgba(14,14,20,0.92))",
                borderColor: state === "completed"
                  ? "rgba(0,230,118,0.35)"
                  : isBoss ? "rgba(255,87,34,0.45)"
                  : "rgba(255,255,255,0.08)",
                boxShadow: locked ? "none" : isBoss ? "0 2px 16px rgba(255,87,34,0.12)" : "0 2px 12px rgba(0,0,0,0.4)",
            ...
            >
              ...
              <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 font-display text-lg"
                style={{ background: state === "completed" ? "rgba(0,230,118,0.12)" : isBoss ? "rgba(255,87,34,0.15)" : "rgba(255,255,255,0.06)", color: state === "completed" ? "#00E676" : isBoss ? "#FF5722" : "#cbd5e1" }}>
